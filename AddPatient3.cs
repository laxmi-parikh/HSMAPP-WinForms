...
namespace HSMAPP
{
    public partial class AddPatient3 : Form
    {
                ...
                using (con = new SqlConnection(dbconnectionstring))
                {
                    ...
                    using (var reader = cmd.ExecuteReader())
                    {
                        if (reader.Read() != false)
                        {
                            ...
                            Regno = reader["RegNo"].ToString();
                            label3 = reader["FirstName"].ToString() + " " + reader["LastName"].ToString();
        ...
        private void chkbloodreport_CheckedChanged_1(object sender, EventArgs e)
        {
            if (chkbloodreport.Checked == true)
            {
                // panel3.Visible = true;
        ...
        private void pboxurinereport_Click_1(object sender, EventArgs e)
        {
            using (OpenFileDialog openFileDialog1 = new OpenFileDialog())
            {
                openFileDialog1.Filter = "Image files(*.jpg,*.jpeg,*.png,*.bmp)|*.jpg;*.jpeg;*.png;*.bmp;";
        ...
        private void pboxxray_Click_1(object sender, EventArgs e)
        {
            using (OpenFileDialog openFileDialog1 = new OpenFileDialog())
            {
                openFileDialog1.Filter = "Image files(*.jpg,*.jpeg,*.png,*.bmp)|*.jpg;*.jpeg;*.png;*.bmp;";
        ...
        private void pboxpft_Click_1(object sender, EventArgs e)
        {
            using (OpenFileDialog openFileDialog1 = new OpenFileDialog())
            {
                openFileDialog1.Filter = "Image files(*.jpg,*.jpeg,*.png,*.bmp)|*.jpg;*.jpeg;*.png;*.bmp;";
        ...
        private void pboxecg_Click_1(object sender, EventArgs e)
        {
            using (OpenFileDialog openFileDialog1 = new OpenFileDialog())
            {
                openFileDialog1.Filter = "Image files(*.jpg,*.jpeg,*.png,*.bmp)|*.jpg;*.jpeg;*.png;*.bmp;";
        ...
        private void pboxaudiomtry_Click_1(object sender, EventArgs e)
        {
            using (OpenFileDialog openFileDialog1 = new OpenFileDialog())
            {
                openFileDialog1.Filter = "Image files(*.jpg,*.jpeg,*.png,*.bmp)|*.jpg;*.jpeg;*.png;*.bmp;";
        ...
        private void chkUrinereport_CheckedChanged_1(object sender, EventArgs e)
        {
            if (chkUrinereport.Checked == true)
            {
                // panel3.Visible = true;
        ...
        private void chkxraychestreport_CheckedChanged_1(object sender, EventArgs e)
        {
            if (chkxraychestreport.Checked == true)
            {
                // panel3.Visible = true;
        ...
        private void chkpftreport_CheckedChanged_1(object sender, EventArgs e)
        {
            if (chkpftreport.Checked == true)
            {
                // panel3.Visible = true;
        ...
        private void pboxgovtform_Click_1(object sender, EventArgs e)
        {
        ...
        private void chkgovtform_CheckedChanged_1(object sender, EventArgs e)
        {
            if (chkgovtform.Checked == true)
            {
                // panel3.Visible = true;
        ...
        private void btnPaymentadd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (con = new SqlConnection(dbconnectionstring))
                {
                    ...
                    if (comboBox1.SelectedValue != null && txtpaymentamt.Text != string.Empty)
                    {
        ...
        private void txtgovtform_TextChanged(object sender, EventArgs e)
        {
